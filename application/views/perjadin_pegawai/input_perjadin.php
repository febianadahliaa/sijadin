...
<div id="container-fluid">
	...
	<div class="card mb-3">
		<div class="card-header">
			<a href="<?php echo site_url('kasie/input_perjadin/') ?>"><i class="fas fa-arrow-left"></i> Daftar perjadin pegawai</a>
		</div>
		...
		<div class="card-body">
			...
			<form action="<?php base_url('kasie/input_perjadin/add') ?>" method="post" enctype="multipart/form-data" >
				<div class="form-row">
